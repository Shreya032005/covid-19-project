...
class Ui_MainWindow(object):
    ...
    def classifyFunction(self):
        try:
          ...
          test_image = load_img(self.file, target_size=(128, 128))
    ...
    def trainingFunction(self):
          try:
              ...
              training_set = train_datagen.flow_from_directory(r"D:\TrainingDataset", target_size=(128, 128), batch_size=8, class_mode='categorical')
              test_set = test_datagen.flow_from_directory(r'D:\TestingDataset', target_size=(128, 128), batch_size=8, class_mode='categorical')
